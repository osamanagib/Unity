...
namespace InfinityCode.RealWorldTerrain.Utils
{
    ...
    public class RealWorldTerrainGPXObject
    {
        ...
        public class Bounds
        {
            ...
            {
                get { return _minlat; }
                set { _minlat = RealWorldTerrainUtils.Clip(value, -90, 90); }
            }
            ...
            {
                get { return _minlon; }
                set { _minlon = RealWorldTerrainUtils.Repeat(value, -180, 180); }
            }
            ...
            {
                get { return _maxlat; }
                set { _maxlat = RealWorldTerrainUtils.Clip(value, -90, 90); }
            }
            ...
            {
                get { return _maxlon; }
                set { _maxlon = RealWorldTerrainUtils.Repeat(value, -180, 180); }
            }
        ...
        public class Waypoint
        {
            ...
            {
                get { return _lat; }
                set { _lat = RealWorldTerrainUtils.Clip(value, -90, 90); }
            }
            ...
            {
                get { return _lon; }
                set { _lon = RealWorldTerrainUtils.Repeat(value, -180, 180); }
            }
            ...
            public double? magvar
            {
                ...
                set
                {
                    if (value.HasValue) _magvar = RealWorldTerrainUtils.Clip(value.Value, 0, 360);
                    else _magvar = null;
                }
            }
