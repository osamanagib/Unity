    ...
    public static class RealWorldTerrainTextureProviderManager
    {
        ...
        private static void InitProviders()
        {
            providers = new[]
            {
                ...
                new Provider("sentinel2", "Sentinel-2")
                {
                    types = new []
                    {
                        new MapType("satellite", "s2s")
                        {
                            url = "https://services.sentinel-hub.com/ogc/wmts/cd280189-7c51-45a6-ab05-f96a76067710?REQUEST=GetTile&TILEMATRIXSET=PopularWebMercator256&LAYER=1_TRUE_COLOR&TILEMATRIX={zoom}&TILEROW={y}&TILECOL={x}&showlogo=false"
                        }, 
                    }
                }, 
